			...
			<div className={styles.inside} data-aos="fade-up">
				<div className={styles.left}>
					...
					<Typography className={styles.copyRight}>
						Copyright © 2020 - 2024 <span>PrivateAlps.</span> All rights reserved.
					</Typography>
				</div>
				<div className={styles.right}>
					<div className={styles.oneList}>
						...
						<Link to="/blog" className={styles.oneTab}>
							<Typography>Blog</Typography>
						</Link>
					</div>
					<div className={styles.oneList}>
						<a href="https://google.com" target="_blank" rel="noreferrer" className={styles.oneTab}>
